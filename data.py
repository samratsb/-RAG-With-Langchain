...
def fetch_and_store_all():
    ...
    # Initialize file counter and logging
    file_counter = 0
    ...
    def fetch_and_store(path='', depth=0, max_depth=10):
        nonlocal file_counter  # Use nonlocal to modify the outer function's file_counter
        if depth > max_depth:
            return
...
# Now you can call fetch_and_store_all() from another file.
